        ...
        <div className="page-container">
          ...
          <div style={{ flex: 1, height: "100vh", overflowY: "auto" }}>
            ...
            <div
              ...
              style={{ padding: "8px 10% 40px 10%", flex: 1 }}
            >
              ...
              <>
                <div
                  style={{
                    display:
                      selectedRole === "Financial Health" ? "block" : "none",
                  }}
                >
                  <FinancialHealth
                ...
                <div
                  style={{
                    display:
                      selectedRole === "SIRS Analysis" ? "block" : "none",
                  }}
                >
                  <SirsAnalysis
                ...
                <div
                  style={{
                    display:
                      selectedRole === "Annual Financial Reporting"
                        ? "block"
                        : "none",
                  }}
                >
                ...
                <div
                  style={{
                    display:
                      selectedRole === "Incident Management" ? "block" : "none",
                  }}
                >
                  <IncidentManagement
                    selectedRole="Incident Management"
                    handleClick={handleClick}
                    setShowFeedbackPopup={setShowFeedbackPopup}
                  />
                </div>
                ...
                <div
                  style={{
                    display:
                      selectedRole === "Custom Reporting" ? "block" : "none",
                  }}
                >
                  <CustomReporting
                ...
                <div
                  style={{
                    display:
                      selectedRole === "Care Plan Document" ? "block" : "none",
                  }}
                >
                  <CareServicesEligibility
                ...
                <div
                  style={{
                    display:
                      selectedRole === "Incident Report" ? "block" : "none",
                  }}
                >
                  <IncidentReport
                ...
                <div
                  style={{
                    display:
                      selectedRole === "Rostering Automation"
                        ? "block"
                        : "none",
                  }}
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ fontSize: "12px", fontFamily: "Inter" }}>
                        I can help with Support at Home, NDIS, compliance and
                        reporting
                      </div>
                    </div>
