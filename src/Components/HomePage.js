        ...
        <>
            {showPricingModal === true ?
                ...
                <div className="page-container">
                    {sidebarVisible ? (
                        <Sidebar onCollapse={toggleSidebar} selectedRole={selectedRole} setSelectedRole={setSelectedRole}  majorTypeofReport={majorTypeofReport} setMajorTypeOfReport={setMajorTypeOfReport} user={user} handleLogout={handleLogout} setShowDropdown={setShowDropdown} setShowSignIn={setShowSignIn} showDropdown={showDropdown} />
                    ) : (
                    ...
                    <div style={{ flex: 1, height: '100vh', overflowY: 'auto', }}>
                        ...
                        <div className="main-content" style={{ padding: '8px 10% 40px 10%', flex: 1 }}>
                            ...
                            <>
                                ...
                                <div style={{ display: selectedRole === 'Incident Management' ? 'block' : 'none' }}>
                                    <IncidentManagement selectedRole="Incident Management" handleClick={handleClick}  setShowFeedbackPopup={setShowFeedbackPopup}/>
                                </div>
